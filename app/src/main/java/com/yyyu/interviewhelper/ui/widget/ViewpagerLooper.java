...
public class ViewpagerLooper extends LinearLayout{
    ...
    private int indicator_seleced_color;
     ...
     * 页面切换间隔时间
     */
    private final long spaceTime = 5*1000;
    ...
    public ViewpagerLooper(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        indicator_seleced_color = ta.getColor(R.styleable.ViewPageLooper_dot_selected_color ,0xff0092a4);
        ta.recycle();
        //初始化画笔
        mPaint = new Paint();
    ...
    protected void dispatchDraw(Canvas canvas) {
        super.dispatchDraw(canvas);
         /*画出指示器*/
        mPaint.setColor(indicator_seleced_color);
